...
export default function MobileBar() {
  ...
  return (
    <nav
      className={`fixed left-2 right-2 z-50 flex items-center gap-0.5 overflow-hidden rounded-md bg-neutral-900/95 border border-white/[0.08] backdrop-blur-md md:hidden transition-[bottom] ${
    ...
    >
      <a
        ...
        className="flex flex-1 flex-col items-center justify-center gap-0.5 py-3 text-white active:bg-white/5 transition-colors duration-150 cursor-pointer"
      >
        <i className="ri-phone-line text-[20px]" aria-hidden="true"></i>
