...
export const services: Service[] = [
  {
    ...
    intro:
      "¿Se ha quedado sin luz o nota olor a quemado en el cuadro eléctrico? Una avería eléctrica no espera y puede ser peligrosa. En Electric acudimos de urgencia a domicilios y locales de Barakaldo, Bilbao y toda Bizkaia para localizar y reparar la avería con garantía de seguridad.",
    bullets: [
    ...
    faqs: [
      {
        ...
        a: "En Barakaldo y municipios cercanos de Bizkaia solemos llegar en menos de 60 minutos desde la llamada, dependiendo de la hora y el tráfico.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Un cortocircuito en casa puede provocar desde un simple corte de luz hasta un riesgo real de incendio. En Electric localizamos el origen del cortocircuito y lo reparamos con seguridad, en Barakaldo, Bilbao y toda Bizkaia.",
    bullets: [
  ...
  },
  {
    ...
    intro:
      "Realizamos instalaciones eléctricas completas para obra nueva, reformas integrales y locales comerciales en Barakaldo y toda Bizkaia, cumpliendo con el Reglamento Electrotécnico de Baja Tensión.",
    bullets: [
  ...
  },
  {
    ...
    intro:
      "Desde un enchufe que no funciona hasta una reforma parcial de la instalación: reparamos cualquier incidencia eléctrica en tu vivienda o local, en Barakaldo y toda Bizkaia.",
    bullets: [
  ...
  },
  {
    ...
    intro:
      "Cortes de luz, cortocircuitos, olor a quemado o un diferencial que no deja de saltar: en Electric ofrecemos servicio de electricista urgente 24 horas en Barakaldo y toda Bizkaia, también noches, fines de semana y festivos.",
    bullets: [
      "Atención inmediata las 24 horas del día",
      "Cobertura en Barakaldo, Bilbao y municipios de Bizkaia",
